...
var ChartContainer = React15.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(DrawingProvider, {
    ...
    margin,
    svgRef,
    children: (0, import_jsx_runtime8.jsx)(ColorProvider, {
      colorProcessors,
      children: (0, import_jsx_runtime8.jsx)(SeriesContextProvider, {
        ...
        children: (0, import_jsx_runtime8.jsx)(CartesianContextProvider, {
          ...
          xExtremumGetters,
          yExtremumGetters,
          children: (0, import_jsx_runtime8.jsx)(ZAxisContextProvider, {
            zAxis,
            dataset,
...
function useColorProcessor(seriesType) {
  const colorProcessors = React32.useContext(ColorContext);
  if (!seriesType) {
...
function DefaultPropsProvider(props) {
  return (0, import_jsx_runtime20.jsx)(DefaultPropsProvider_default, _extends({}, props));
}
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime22.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime22.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime22.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime22.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React39.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime36.jsxs)(ResponsiveChartContainer, {
    ...
    xAxis: xAxis ?? [{
      ...
      scaleType: "point",
      data: [...new Array(Math.max(...series.map((s2) => s2.data.length)))].map((_, index) => index)
    }],
    yAxis,
    colors: colors3,
    sx,
